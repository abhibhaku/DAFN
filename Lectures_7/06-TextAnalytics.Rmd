---
title: 'More than Words: Text Analytics'
output:
  slidy_presentation: default
---


# More than Words: Text Analytics {#TextAnalytics}

## Introduction

Text expands the universe of data many-fold. See my monograph on text mining in finance at:
...
2. Text is versatile. Nuances and behavioral expressions are not conveyed with numbers, so analyzing text allows us to explore these aspects of human interaction.
3. Text contains emotive content. This has led to the ubiquity of "Sentiment analysis". See for example: Admati-Pfleiderer 2001; DeMarzo et al 2003; Antweiler-Frank 2004, 2005; Das-Chen 2007; Tetlock 2007; Tetlock et al 2008; Mitra et al 2008; Leinweber-Sisk 2010.
4. Text contains opinions and connections. See: Das et al 2005; Das and Sisk 2005; Godes et al 2005; Li 2006; Hochberg et al 2007.
5. Numbers aggregate; text disaggregates. Text allows us to drill down into underlying behavior when understanding human interaction.
...
3. Simple: Text mining may be simple as key word searches and counts.
4. Complicated: It may require language parsing and complex rules for information extraction.
5. Involves structured text, such as the information in forms and some kinds of web pages.
6. May be applied to unstructured text is a much harder endeavor.
...
![](DSTMAA_images/news_posters1.png)

### Breakdown of News Flow

![](DSTMAA_images/news_posters2.png)

### Frequency of Postings

![](DSTMAA_images/posters_histogram.png)

### Weekly Posting

![](DSTMAA_images/weekly_postings.png)

### Intraday Posting

![](DSTMAA_images/intraday_postings.png)

### Number of Characters per Posting

![](DSTMAA_images/characters_postings.png)
...
#Print a few lines
print(lapply(ctext, as.character)[10:15])
...
##  Web Extraction using the *rvest* package
...
This more direct code chunk does handshaking better and faster than the preceding. Go to https://apps.twitter.com/
...
Now we move on to using Facebook, which is a little less trouble than Twitter. Also the results may be used for creating interesting networks. The site for set up is: https://developers.facebook.com/
...
Type "fb_oauth" see the token and then use it below. 
...
8. Associative dictionaries are also useful when trying to find context, as the word may be related to a concept, identified using a dictionary such as
...
1. Das and Chen (2007) constructed a lexicon of about 375 words that are useful in parsing sentiment from stock message boards.  
...
![](DSTMAA_images/dell_senty_plot.png)

### Stock Sentiment Correlations

![](DSTMAA_images/StkSentCorr.png)

### Phase Lag Analysis

![](DSTMAA_images/PhaseLagAnalysis.png)
...
![](DSTMAA_images/DasChen2007.png)
![](DSTMAA_images/DasChenSystemDesign.png)
![](DSTMAA_images/OptimismScore.png)
![](DSTMAA_images/AmbiguityClassification.png)
![](DSTMAA_images/TechSentiment.png)
![](DSTMAA_images/SentimentAndVolatility.png)
![](DSTMAA_images/SentimentCorrelations.png)
...
![](DSTMAA_images/Midas_Architecture.png)
![](DSTMAA_images/Midas_FilingMap.png)
![](DSTMAA_images/Midas_Insider_Holdings.png)
![](DSTMAA_images/Midas_Insider_Transactions.png)
![](DSTMAA_images/Midas_LoanNet2005.png)
![](DSTMAA_images/Midas_LoanNet2006-2009.png)
![](DSTMAA_images/Midas_Centrality2005.png)


### Stock Twits

![](DSTMAA_images/StockTwits_Prices.png)
![](DSTMAA_images/StockTwits_Messages.png)
![](DSTMAA_images/StockTwits_Sentiment.png)

### iSentium

![](DSTMAA_images/iSentium_iSense.png)
![](DSTMAA_images/iSentium_iSense_ShortTerm.png)
![](DSTMAA_images/iSentium_iSense_LongTerm.png)

### RavenPack

![](DSTMAA_images/Ravenpack_MacroSignals.png)
...
where $T \in {\cal R}^{m \times n}$ and $D \in {\cal R}^{n \times n}$ are orthonormal to each other, and $S \in {\cal R}^{n \times n}$ is the "singular values" matrix, i.e., a diagonal matrix with singular values on the diagonal. These values denote the relative importance of the terms in the TDM.
...
![](DSTMAA_images/topycs1.png)

![](DSTMAA_images/topycs2.png)
...
![](DSTMAA_images/Dilbert_UnstructuredText.png)
